...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZIGBEE_SCENES_LOG_LEVEL_DEFAULT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZIGBEE_CHANNEL, 25);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PRO_MICRO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PRO_MICRO_NRF52840, 1);
